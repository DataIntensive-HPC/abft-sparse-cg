...
#define DOT_PRODUCT_KERNEL_WG 128
#define DOT_PRODUCT_KERNEL_ITEMS_PER_WORK_ITEM 16

#define CALC_XR_KERNEL_WG 128
#define CALC_XR_KERNEL_ITEMS_PER_WORK_ITEM 16

#define CALC_P_KERNEL_WG 64
#define CALC_P_KERNEL_ITEMS_PER_WORK_ITEM 16
